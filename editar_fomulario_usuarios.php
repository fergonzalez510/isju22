   <div class="row-fluid">
       <a href="usuarios.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Agregar Usuario</a>
                        ...
                        <div class="block">
							...
							<?php
							$query = mysqli_query($connection,"select * from usuarios where usuarioid = '$get_id'")or die(mysql_error());
...
mysqli_query($connection,"update users set nombreusuario = '$uname',nombre ='$fname', apellido='$lname',estado='$status' where usuarioid = '$get_id' ")or die(mysql_error());
?>

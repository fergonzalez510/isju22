					...
					<p>&#191;Esta seguro de eliminar registro del estudiante?.</p>
					</div>
					</div>
					...
					<div class="modal-body">
					<div class="alert alert-danger">
					<p>&#191;Esta seguro de eliminar registro de Curso?.</p>
					</div>
					</div>
					<div class="modal-footer">
					<button class="btn" data-dismiss="modal" aria-hidden="true"><i class="icon-remove icon-large"></i> Cerrar</button>
					...
					<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
					<h3 id="myModalLabel">&#191;Eliminar registro de usuario?</h3>
					</div>
					<div class="modal-body">
					<div class="alert alert-danger">
					<p>&#191;Esta seguro de eliminar registro de usuario?</p>
					</div>
					</div>
					<div class="modal-footer">
					<button class="btn" data-dismiss="modal" aria-hidden="true"><i class="icon-remove icon-large"></i> Cerrar</button>

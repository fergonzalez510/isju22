...
<?php $get_id = $_GET['id']; ?>
    <body>
		<?php include('navbar.php'); ?>
		 <center><img src="default/img/logoISJU.png"></center>
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('barra_lateral_usuarios.php'); ?>
				<div class="span3" id="">
				<?php include('editar_formulario_usuarios.php'); ?>		   			
				</div>
                <div class="span6" id="">
                     <div class="row-fluid">
                        <!-- block -->
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
									 	...
									 	<?php 
											$user_query = mysqli_query($connection,"select * from usuarios");
											$count = mysqli_num_rows($user_query);
										?>

											<div class="muted pull-left"><i class="icon-reorder icon-large"></i>Lista Usuarios</div>
